...
export default function StudentTestsPage() {
  ...
  if (!ready || loading) return <Spinner label="Loading your tests…" />;
  ...
  return (
    <PageContainer>
      <PageHeader
        icon={ClipboardList}
        title="My tests"
        subtitle="Assessments assigned to you by your teachers."
      />
      ...
      {items.length === 0 ? (
        <EmptyState
          ...
          desc="When a teacher assigns you a test, it'll appear here. In the meantime, you can practise on your own."
          action={<Button href="/quiz">Practise a quiz</Button>}
        />
      ) : (
